...
- The Bluetooth Electronics App allows you to control your AVRgo-Infinity and flash sketches from the Micro-SD Card directly from any android device (examples provided).
